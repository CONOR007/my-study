...
var vnode = (0, _snabbdom.h)('div#container', [(0, _snabbdom.h)('h1', 'hello snabbdom'), (0, _snabbdom.h)('p', 'p标签'), (0, _snabbdom.h)('p', 'p标签')]);
var app = document.querySelector('#app');
var oldVnode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _snabbdom.h)('div#container', [(0, _snabbdom.h)('h1', 'hello wold'), (0, _snabbdom.h)('p', 'p标签1')]); //patch(oldVnode,vnode);
